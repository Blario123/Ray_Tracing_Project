...
%  Auto-generated by MATLAB on 08-Jan-2022 20:31:49
...
% Create loglog
loglog(X2,Y2,'DisplayName','$\mathcal{O}(N^{-1})$','LineWidth',1,...
    'Color',[1 0 0]);
...
% Create title
title('Variance With Russian Roulette','Interpreter','latex');
...
set(axes1,'FontSize',20,'LabelFontSizeMultiplier',1.5,'XMinorTick','on',...
